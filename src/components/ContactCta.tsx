...
export function ContactCta({ t }: ContactCtaProps) {
  return (
    // Jasne tło pod spodem odsłania wycięcia w zaokrąglonych rogach,
    // przez co ciemna sekcja wchodzi na jasną tak jak panel hero.
    <div className="bg-primary">
      <section
        id="contact"
        className="relative overflow-hidden rounded-t-[28px] bg-bg py-24 text-fg md:py-32"
      >
        <div className="shell">
